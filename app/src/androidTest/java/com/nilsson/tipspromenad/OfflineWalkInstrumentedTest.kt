    ...
    @Test fun bundledCreatorParticipantAndScoringFlow() {
        ...
        ActivityScenario.launch(MainActivity::class.java).use { scenario ->
            ...
            try {
                ...
                screenshot("settings")
                js("const d=document.querySelector('dialog');const s=d.querySelectorAll('select');s[0].value='en';s[1].value='en';s[3].value='all';s[4].value='none';const n=d.querySelectorAll('input[type=number]');n[0].value=5;n[1].value=0;d.querySelector('[data-action=save]').click()")
                waitFor("!document.querySelector('dialog[open]')")
                ...
                assertTrue(js("window.testResultCode").contains("TIPR1."))
                click("home")
